...
trade_note = '2025-09-10 08:00 PM - Previously know as strategy_02_02.py - Added H1 and H4 Candle Size Range Check - Fixed Trailing Stop Logic'
    ...
    try:
        while True:
            try:
                ...
                # DISABLING COMPARED TO STRATEGY 01 Check H1 and H4 candle ranges
