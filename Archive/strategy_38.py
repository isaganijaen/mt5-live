...
class M2AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            # NOTES TABLE
            #--------------------------------                                                                                                       ----------                  
            print(f"Note: EXACTLY LIKE strategy_19 but running in M2 timeframe. NO TARGET.")
            # print(f"Difference:")
            ...
            notes_table.add_row("NOTE","✨ EXACTLY LIKE strategy_19 but running in M2 timeframe. NO TARGET.","")
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=73 if production_status == 'DEMO'  else 38, # if LIVE
        volume = 0.01 if production_status == 'DEV' else 0.01 if production_status == 'DEMO' else 0.1, # if LIVE
        deviation=20,
        sl_points=300, # ✨🔒 NO TARGET, Just a placeholder
        tp_points=350,
