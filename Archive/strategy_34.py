...
class M15AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            # NOTES TABLE
            #--------------------------------                                                                                                       ----------                  
            print(f"Note: In style of strategy_19 but running in M15 timeframe.")
            # print(f"Difference:")
            ...
            notes_table.add_row("Timeframe",f"M15","Analyzing in M15 Candles")        
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=69 if production_status == 'DEMO'  else 34, # if LIVE
        volume = 0.01 if production_status == 'DEV' else 0.01 if production_status == 'DEMO' else 0.1, # if LIVE
        deviation=20,
        sl_points=300,
        tp_points=1200,
        trailing_activation_points=320, # (3500 = 2x ave. candle range in M15) 2000 points or $0.2 profit | 10 = 1000, 20 = 2000
        trailing_stop_distance=320,
        trailing_period=3,
        ema_resistance=3,
        ema_support=3,
