...
class M1AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            tbl_notes.add_row(f"Direct Predecessor: strategy_19_demo.py\n")
            tbl_notes.add_row(f"Main difference: TP=350 Trailing Activation = 320 ")
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=72 if production_status == 'DEMO' else 37, # if live
