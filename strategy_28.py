...
class M2AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            # NOTES TABLE
            #--------------------------------                                                                                                       ----------                  
            print(f"Note: Same as strategy_02.py")
            print(f"Difference:")
            print(f"Uses 50 EMA as Consolidation Filter.")
            print(f"📸 SCREENSHOT ADDED.\n")
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=63 if production_status == 'DEV' else 63 if production_status == 'DEMO'  else 28, # if LIVE
        ...
        ema_resistance=20,
        ema_support=20,
        support_resistance_distance_threshold=130,
