...
class M2AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            # NOTES TABLE
            #--------------------------------                                                                                                       ----------                  
            print(f"Note: Same as strategy_29.py (strategy_02.py)")
            print(f"Difference:")
            print(f"TP=1800 which is the average volatility of 4H Candles) ")
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=65 if production_status == 'DEV' else 65 if production_status == 'DEMO'  else 30, # if LIVE
