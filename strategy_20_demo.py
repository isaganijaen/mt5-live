...
class M1AverageZone:
    ...
    def run(self):
        ...
        while True:
            ...
            # Identifying Trend
            # TRADING with A Long Term Trend
            ...
            tbl_notes.add_row(f"Similarities: (ALL) Super Aggressive 3-Period EMA High/Low/Trail.")
            tbl_notes.add_row(f"Main difference: New LONG TERM TREND = 50 EMA ")
            tbl_notes.add_row(f"Expecting a behavior like DEMO_strategy_03 strategy_18_demo.py and with consistent profitability while trading much actively with no definite TP! ✨.\n")
...
def start_strategy():
    ...
    config_settings = TradingConfig(
        ...
        filename=filename,
        strategy_id=58 if production_status == 'DEMO' else 20, # if live
